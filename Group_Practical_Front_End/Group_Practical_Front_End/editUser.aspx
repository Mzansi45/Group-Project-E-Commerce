<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="editUser.aspx.cs" Inherits="Group_Practical_Front_End.editUser" %>
    ...
    <div class="bg-light p-30 mb-5" style="width: 800px; margin: auto; left: 0; right: 0; top: 0; bottom: 0; margin-top: 100px; border-width: 1px;">
        ...
        <div class="row">
            ...
            <div class="col-md-12 form-group">
                <asp:Button runat="server" class="btn btn-block btn-primary font-weight-bold py-3" Text="Submit Changes" ID="editUserInfo" OnClick="editUserInfo_Click" />
            </div>

            <div class="col-md-12 form-group">
                <p id="errormessage" style="color:red;visibility: hidden;" runat="server" >Could Not Edit the User Information</p>
            </div>
        </div>
    </div>
</asp:Content>
