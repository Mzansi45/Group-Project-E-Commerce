...
namespace Group_Practical_Front_End
{
    ...
    public partial class home : System.Web.UI.Page
    {
        ...
        {
            //always redirect sellers and administrators to shop
            ...
            foreach (category cat in list)
            {
                ...
                home_categories.InnerHtml += "<small class='text-body'></small></div></div></a></div>";
            }
            // Auction Products
        ...
        public void displayAuction(Product prod)
        {
            auction.InnerHtml += "<div class='col-lg-2 col-md-3 col-sm-4 pb-1'>";
            ...
            auction.InnerHtml += "<a class='btn btn-outline-dark btn-square' href='addtowishlist.aspx?Id=" + prod.Id + "&return=home.aspx'><i class='far fa-heart'></i></a>";
        ...
        private void displayCompanyProducts(Product prod)
        {
            company_products.InnerHtml += "<div class='col-lg-2 col-md-3 col-sm-4 pb-1'>";
            company_products.InnerHtml += "<div class='product-item bg-light mb-4'>";
            company_products.InnerHtml += "<div class='product-img position-relative overflow-hidden'>";
            company_products.InnerHtml += "<a href='single.aspx?Id=" + prod.Id + "'><img class='img-fluid w-100' src=" + prod.Image + " alt=''></a>";
            company_products.InnerHtml += "<div class='product-action'>";
            company_products.InnerHtml += "<a class='btn btn-outline-dark btn-square' href='addtocart.aspx?Id=" + prod.Id + "&return=home.aspx&Add=0'><i class='fa fa-shopping-cart'></i></a>";
            company_products.InnerHtml += "<a class='btn btn-outline-dark btn-square' href=''><i class='far fa-heart'></i></a>";
            company_products.InnerHtml += "<a class='btn btn-outline-dark btn-square' href='shop.aspx'><i class='fa fa-sync-alt'></i></a>";
            company_products.InnerHtml += "<a class='btn btn-outline-dark btn-square' href='single.aspx?Id=" + prod.Id + "'><i class='fa fa-search'></i></a></div></div>";
            company_products.InnerHtml += "<div class='text-center py-4'>";
            company_products.InnerHtml += "<a class='h6 text-decoration-none text-truncate' href='single.aspx?Id=" + prod.Id + "'>" + prod.Product_Name + "</a>";
            company_products.InnerHtml += "<div class='d - flex align-items-center justify-content-center mt-2'>";
            if (prod.Discount_Price != null)
            {
                company_products.InnerHtml += "<a href='single.aspx?Id=" + prod.Id + "'><h5>R" + String.Format("{0:0.##}", prod.Discount_Price) + "</h5><h6 class='text-muted ml-2'>R<del>" + String.Format("{0:0.##}", prod.Product_Price) + "</</del></h6></div></a>";
            }
            else
            {
                company_products.InnerHtml += "<a href='single.aspx?Id=" + prod.Id + "'><h5>R" + String.Format("{0:0.##}", prod.Product_Price) + "</h5></div></a>";
            }
            company_products.InnerHtml += "<div class='d-flex align-items-center justify-content-center mb-1'>";
            company_products.InnerHtml += "<small class='far fa-star text-primary mr-1'></small>";
            company_products.InnerHtml += "<small class='far fa-star text-primary mr-1'></small>";
            company_products.InnerHtml += "<small class='far fa-star text-primary mr-1'></small>";
            company_products.InnerHtml += "<small class='far fa-star text-primary mr-1'></small>";
            company_products.InnerHtml += "<small class='far fa-star text-primary mr-1'></small>";
            company_products.InnerHtml += "<small>(99)</small>";
            company_products.InnerHtml += "</div></div></div></div>";
        }
    }
}